...
```{r}
setwd("C:/Users/bgers/Desktop/raster_runs")
writeRaster(srtm_sr, filename="srtm_sr.tif", format="GTiff", overwrite=TRUE)
...
sq.i <- texture_image(srtm_sr, window_type = 'circular', 
                                   size = 3, 
                                   metric = 'sq', parallel = ,
                                  ncores=10, nclumps = 100)
...
sq.test <- texture_image(srtm_sr, window_type = 'circular', 
                                   size = 3, 
                                   metric = 'sq', parallel = F,
                                 , nclumps = 100)
...
sq <- focal_metrics(srtm_sr, window, metrics = list('sq'),
                    progress = TRUE)
